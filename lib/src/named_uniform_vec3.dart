...
class NamedUniformVec3 extends Vec3 {
  ...
  /// offset for the case where the vec3 field is in an array.
  ///
  /// See also:
  ///
  /// * [FragmentShader.getUniformFloat] which provides the base access to
  ...
  /// The name of the associated vec3 uniform defined within the shader.
  final String name;
  /// An additional offset from the named uniform defined within the shader,
  /// useful for when the vec3 is in an array.
  final int offset;

  // The internal UniformFloatSlot used to access the floats of the vec3.
